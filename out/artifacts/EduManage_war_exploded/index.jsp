        ...
        <div class="col-md-6">
            <div class="custom-card">
                <div class="card-body">
                    ...
                    <p class="card-text">Cliquez ici pour accéder à la gestion des étudiants.</p>
                    <a href="Student/" class="btn custom-btn btn-primary">
                        <i class="fa-solid fa-users me-2"></i>Accéder
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="custom-card">
                <div class="card-body">
                    ...
                    <p class="card-text">Cliquez ici pour accéder à la gestion des cours.</p>
                    <a href="cours" class="btn custom-btn btn-success">
                        <i class="fa-solid fa-book me-2"></i>Accéder
                    </a>
                </div>
            </div>
        </div>
